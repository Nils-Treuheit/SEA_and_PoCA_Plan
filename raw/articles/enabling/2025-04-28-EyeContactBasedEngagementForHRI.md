...
---
title: "Eye Contact Based Engagement Prediction for dyadic Human-Robot Interaction"
description: We present a novel method for engagement prediction in human–robot interaction (HRI) using eye contact detection. Our approach combines computer vision techniques for eye gaze estimation with machine learning models to predict engagement levels in real-time, enabling robots to respond appropriately to human interaction cues.
background: /assets/theme/images/header-img.jpg
image: /assets/theme/images/EyeContactBasedEngagementForHRI.png
author: "Jan Marquenie, Basheer Al-Tawil, Magnus Jung, Thorsten Hempel, Ayoub Al-Hamadi"
categories: [Publication, Conference, Human-Robot Interaction, Engagement]
conference: "**ROBOVIS 2025**"
tags: [ROBOVIS 2025, Conference, Engagement, HRI]
---

## Eye Contact Based Engagement Prediction for dyadic Human-Robot Interaction

Engagement is a critical aspect of human–robot interaction (HRI) that significantly influences interaction quality and user experience. Accurate engagement prediction enables robots to adapt their behavior in response to human interaction cues, leading to more natural and effective interactions. 

We present a novel method for engagement prediction in human–robot interaction (HRI) using eye contact detection. Our approach combines computer vision techniques for eye gaze estimation with machine learning models to predict engagement levels in real-time, enabling robots to respond appropriately to human interaction cues.

Our method consists of three main components:
1. **Eye Gaze Estimation**: Using computer vision techniques to estimate the direction of human gaze relative to the robot
2. **Eye Contact Detection**: Determining when the human's gaze is directed toward the robot (eye contact)
3. **Engagement Prediction**: Using machine learning models to predict engagement levels based on eye contact patterns and duration

We evaluate our approach on a dataset of dyadic HRI scenarios and demonstrate that eye contact-based features significantly improve engagement prediction accuracy compared to baseline methods that do not consider eye contact specifically.

The real-time capability of our method enables robots to dynamically adjust their behavior based on predicted engagement levels, leading to more natural and effective human-robot interactions.
